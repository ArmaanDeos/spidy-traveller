  ...
  return (
    <>
      ...
      <section className="block md:hidden py-4 px-3 bg-white shadow-md rounded mt-[80px] mb-[80px]">
        {/* Header */}
        <div className="bg-gray-900 text-white py-2 rounded mb-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm font-fira mb-4">
          {[
            ...
            <a
              ...
              className="bg-gray-900 text-white py-2 rounded text-center"
            >
              {text}
            </a>
          ))}
        ...
        {/* Phone Box */}
        <div className="bg-gray-900 text-white rounded-full px-5 py-3 flex flex-wrap items-center justify-center gap-3 mt-4 max-w-xs mx-auto">
        ...
        {/* Fixed Bottom CTA */}
        <div className="mobileCta fixed bottom-0 left-0 right-0 w-full bg-gray-900 py-3 px-4 z-[999999] shadow-md">
